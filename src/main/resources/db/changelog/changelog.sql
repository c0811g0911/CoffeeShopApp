...
INSERT INTO customers(id,"name",address,phone,email,user_name, password, created_at, updated_at)  VALUES
                                                                          (1,'ERIC', 'Hanoi VietNam', '90090900','eric@gmail.com', 'eric', '12345678', NOW()),
                                                                          (2,'ERIC1', 'Hanoi VietNam', '90090900','eric1@gmail.com', 'eric1', '12345678', NOW()),
                                                                          (3,'ERIC2', 'Hanoi VietNam', '90090900','eric2@gmail.com', 'eric2', '12345678', NOW());
...
INSERT INTO shops(id, "name",description,address,phone,user_name, password,longitude,latitude, open_time, closed_time, created_at, updated_at)  VALUES
                                                                                                                             (1,'SHOP_ERIC','Eric shop', 'Hanoi VietNam', '90090900', 'eric', '12345678',111.11,222.22, '08:00','22:00', NOW()),
                                                                                                                             (2,'SHOP_ERIC1','Eric shop1', 'Hanoi VietNam', '90090900', 'eric1', '12345678', 332.22, 212.11,'08:00','22:00', NOW());
...
INSERT INTO menu_items(id,"name",price,currency, menu_id, created_at, updated_at)  VALUES
                                                                 (1, 'Black Coffee',1, 'USD', 1, NOW()),
                                                                 (2, 'Milk Coffee',1, 'USD', 1, NOW()),
                                                                 (3, 'Orange Juice',1, 'USD', 1, NOW()),
                                                                 (4, 'Black Coffee',1, 'USD', 2, NOW()),
                                                                 (5, 'Milk Coffee',1, 'USD', 2, NOW()),
                                                                 (6, 'Orange Juice',1, 'USD', 2, NOW());
